...
import { saveEmpanadasFlavors, type EmpanadasFlavor } from "@/lib/actions/settings";

export default function EmpanadasFlavorsForm({ initial }: { initial: EmpanadasFlavor[] }) {
  const [flavors, setFlavors] = useState<EmpanadasFlavor[]>(initial);
  ...
  function handleSave() {
    ...
    startTransition(async () => {
      const res = await saveEmpanadasFlavors(flavors);
      setMsg(res.success
